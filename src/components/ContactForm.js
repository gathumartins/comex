          ...
          <form ref={form} onSubmit={sendContact} className="mt-10 md:max-w-[1200px] mx-auto">
              <div className="md:flex justify-between gap-10">
                  <div className="w-full relative">
                      <input type="text" name="firstName" id="firstName" className="peer mb-10 bg-transparent h-10 w-full border-b-2 border-black focus:outline-none focus:border-white placeholder-transparent" placeholder="FIRST NAME" required/>
                  ...
                  <div className="w-full relative">
                  <input type="text" name="lastName" id="lastName" className="peer mb-10 bg-transparent h-10 w-full border-b-2 border-black focus:outline-none focus:border-white placeholder-transparent" placeholder="LAST NAME" required/>
              ...
              <div className="md:flex justify-between gap-10">
                  <div className="w-full relative">
                      <input type="tel" name="phone" id="phone" className="peer mb-10 bg-transparent h-10 w-full border-b-2 border-black focus:outline-none focus:border-white placeholder-transparent" placeholder="PHONE NUMBER" required/>
                  ...
                  <div className="w-full relative">
                      <input type="email" name="email" id="email" className="peer mb-10 bg-transparent h-10 w-full border-b-2 border-black focus:outline-none focus:border-white placeholder-transparent" placeholder="EMAIL" required/>
              ...
              <div className="relative">
                  <input type="text" name="message" id="message" className="peer mb-10  bg-transparent h-12 w-full border-b-2 border-black focus:outline-none focus:border-white placeholder-transparent" placeholder="MESSAGE" required/>
